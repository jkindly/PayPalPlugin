...
/**
 * PostgreSQL counterpart of Version20260909120000: creates the shipment tracking table. Sylius's
 * migration base classes skip on the "wrong" platform, so the MySQL and PostgreSQL variants are
 * provided separately; both build the schema through the Schema API.
 */
