...
/**
 * Creates the plugin-owned shipment tracking table (keyed by shipment) that holds the carrier,
 * the PayPal tracker identifier and the sync state. Sylius's migration base classes skip on the
 * "wrong" platform, so this MySQL variant is paired with Version20260909120001 for PostgreSQL;
 * both build the schema through the Schema API.
 */
final class Version20260909120000 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Add sylius_paypal_plugin_shipment_tracking table (MySQL)';
    }
